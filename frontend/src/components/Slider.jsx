...
export default function Slider({ images }){
  ...
  const handlePointerMove = (e) => {
    ...
    const currentX = e.clientX || e.touches[0].clientX; // representa la posición horizontal actual del puntero del mouse o del dedo del usuario durante el movimiento en el slider.
    const diffX = startX - currentX; 
    /*
    Esto da como resultado la distancia que se ha movido 
    el puntero desde que comenzó el deslizamiento. 
    Si diffX es positivo, significa que el usuario ha deslizado hacia la izquierda, y si es negativo, ha deslizado hacia la derecha.*/
  ...
  // Creo eventHandlers si estoy en móvil para activarlos si la pantalla es de móvil
    ...
    : {};
    return (
      <div className="relative w-full max-w-4xl mx-auto overflow-hidden select-none"
      {...eventHandlers}>
